...
public class RecursosLocalidad implements java.io.Serializable {
    ...
    public void getRecursosForTable(DefaultTableModel model) {
        model.addRow(new Object[]{"Urgencias: " + this.telefonoUrgencias});
        model.addRow(new Object[]{"Ambulatorio: " + this.telefonoAmbulatorio});
        model.addRow(new Object[]{"Hospital: " + this.telefonoHospital});
        model.addRow(new Object[]{"Bomberos: " + this.telefonoBomberos});
        model.addRow(new Object[]{"Guardia Civil: " + this.telefonoGuardiaCil});
        model.addRow(new Object[]{"Policia Local: " + this.telefonoPoliciaLocal});
        model.addRow(new Object[]{"Policia Nacional: " + this.telefonoPoliciaNacional});
    }
    ...
    public String[] returnRecursosForList() {
        return new String[]{"Urgencias: " + this.telefonoUrgencias,
            "Ambulatorio: " + this.telefonoAmbulatorio,
            "Hospital: " + this.telefonoHospital,
            "Bomberos: " + this.telefonoBomberos,
            "Guardia Civil: " + this.telefonoGuardiaCil,
            "Policia Local: " + this.telefonoPoliciaLocal,
            "Policia Nacional: " + this.telefonoPoliciaNacional
        };
    }
